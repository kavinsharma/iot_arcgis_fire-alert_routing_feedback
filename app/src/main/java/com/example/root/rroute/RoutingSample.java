...
public class RoutingSample extends AppCompatActivity implements
        ...
        RoutingDialogFragment.onGetRoute,View.OnClickListener {

    public static MapView map = null;
    ArcGISTiledMapServiceLayer tileLayer;
    GraphicsLayer Alert,routeLayer, hiddenSegmentsLayer;
    ...
    public static Point mLocation = null,alert1;
    ...
    private static final String TAG = "RoutingSample";
              ...
              /*  Userdata uInfo = new Userdata();
                ...
                */Alert = new GraphicsLayer();
                ...
                PictureMarkerSymbol destinationSymbol = new PictureMarkerSymbol(
                        ...
                        R.mipmap.trash));
                alert1 = new Point(77.849634,28.406785 );
                Point a = (Point) GeometryEngine.project(alert1,egs,wm);

                // Point pointGeometry = new Point( 77.981931,);
                Graphic pointGraphic = new Graphic(a, destinationSymbol);


                Alert.addGraphic(pointGraphic);
                map.addLayer(Alert);
            }
...
*/
            ...
            userCredentials.setUserAccount("pritamneog2", "P1YcYUr@");
            //userCredentials.setUserToken("DRqGSuAG4upAKfn-XOM7wNMQThZ9aU8Lh2ALWfp6dVXJ1kJzAIUwprxBQVbITFWhTVCmyKHiSzFOJv0kipiNEy8_ivmg5Kyi9uT7QUYfnEuTmBYBh5Vgkgozv6ISbRNDR9pxoWbMxuIfrblFhdajvw..","SFKq5AeDQHN1aFXp");
